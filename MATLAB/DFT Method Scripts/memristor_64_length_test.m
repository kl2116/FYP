...
L = 64;              % Length of signal   NB: MUST be power of 2
...
Vin = zeros(8,64); %Please parametrise the number of columns of this, and make it 2^M
Vin(1,1:64) = v1;
Vin(2,1:64) = v2;
Vin(3,1:64) = v3;
Vin(4,1:64) = v4;
...
FT_I1 = fft(Iout(1,1:64));
FT_I2 = fft(Iout(2,1:64));
FT_I3 = fft(Iout(3,1:64));
FT_I4 = fft(Iout(4,1:64));
FT_I5 = fft(Iout(5,1:64));
FT_I6 = fft(Iout(6,1:64));
FT_I7 = fft(Iout(7,1:64));
FT_I8 = fft(Iout(8,1:64));
